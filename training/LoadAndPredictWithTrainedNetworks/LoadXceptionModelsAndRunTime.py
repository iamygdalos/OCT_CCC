...
model.load_weights('D:\\MA_Luisa\\models\\FINAL_2\\all_20210612_081351\\xception_ckpt3\\xception_MaskedSquaredHalf_2_3').expect_partial()
...
img = cv2.imread('D:\\MA_Luisa\\data\\exportKRLM_2_Half\\abnormal\\2007131650IA_A\\2\\2007131650IA_A_278_2.png', cv2.IMREAD_UNCHANGED)

print("--- Load Image %s seconds ---\n" % (time.time() - start_time))
start_time = time.time()
...
print("--- Preprocess Image %s seconds ---\n" % (time.time() - start_time))
start_time = time.time()
